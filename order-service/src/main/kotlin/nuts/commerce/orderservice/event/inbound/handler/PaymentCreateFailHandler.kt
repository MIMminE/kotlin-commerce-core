...
class PaymentCreateFailHandler(
    ...
    override fun handle(orderInboundEvent: OrderInboundEvent) {
        ...
        val payload = orderInboundEvent.payload as PaymentCreationFailedPayload
        ...
        orderRepository.updateStatus(orderId, OrderStatus.CREATED, OrderStatus.PAYMENT_FAILED)
