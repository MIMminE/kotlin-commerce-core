...
![System overview](../portfolio/system-overview.svg)
...
![Web client preview](../portfolio/web-client-preview.png)

백엔드 아키텍처 프로젝트는 API 호출 예시만 있으면 읽는 사람이 흐름을 상상해야 합니다. 그래서 간단한 브라우저 데모 UI를 붙였습니다.

화면에서는 상품을 조회하고, 주문을 생성하고, 최근 주문을 확인할 수 있습니다. 이 UI는 화려한 프론트엔드가 목적이 아니라, 주문 이벤트 흐름을 눈으로 따라갈 수 있게 하는 장치입니다.

## 주문 이벤트 흐름

![Order flow](../portfolio/order-flow.svg)
...
![Outbox flow](../portfolio/outbox-flow.svg)
