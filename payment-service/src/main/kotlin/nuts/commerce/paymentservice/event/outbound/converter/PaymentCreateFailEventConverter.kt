...
@Component
class PaymentCreateFailEventConverter(private val objectMapper: ObjectMapper) : OutboundEventConverter {

    override val supportType: OutboundEventType
        get() = OutboundEventType.PAYMENT_CREATION_FAILED
    ...
    override fun convert(outboxInfo: OutboxInfo): PaymentOutboundEvent {
        return PaymentOutboundEvent(
            ...
            payload = objectMapper.readValue(
                outboxInfo.payload, PaymentCreationFailPayload::class.java
            )
        )
    }
